...
parser.add_argument('--source_synapse_workspace_name', type=str, required=True, help='Name of Synapse Workspace')
parser.add_argument('--source_synapse_workspace_resource_group_name', type=str, required=True, help='Resource group name of Synapse Workspace')
parser.add_argument('--source_batch_account_query_umi_name', type=str, required=True, help='UMI name to grant access on batch account')
parser.add_argument('--source_batch_account_query_umi_resource_group_name', type=str, required=True, help='Resource group name for UMI to grant access on batch account')
...
synapse_managed_identity_query_command = "az synapse workspace show --name " + args.source_synapse_workspace_name +" --resource-group " + args.source_synapse_workspace_resource_group_name
...
umi_principal_id_query_command = "az identity show --name " + args.source_batch_account_query_umi_name + " --resource-group " + args.source_batch_account_query_umi_resource_group_name
